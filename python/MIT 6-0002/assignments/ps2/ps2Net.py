...
#
import unittest
from graphNet import Digraph, Node, WeightedEdge
...
def get_best_path(digraph, start, end, path, max_dist_outdoors, best_dist, best_path):
    ...
    if start == end:
        if total_dist <= best_dist: # moze i bez =
...
def directed_dfs(digraph, start, end, max_total_dist, max_dist_outdoors):
    ...
    if best_path_result[0] is not None and best_path_result[1] <= max_total_dist:
