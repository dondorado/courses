...
class Robot(object):
    ...
    def get_robot_direction(self):
        ...
        degrees, 0.0 <= d < 360.0.
        """
        return float(random.randrange(0, 361))
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        x = self.width - 1
        y = self.height - 1
        return Position(random.randint(0, x), random.randint(0, y))
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        x = math.floor(pos.get_x())
        y = math.floor(pos.get_y())
        return (x, y) not in self.furniture_tiles and super().is_position_in_room(pos)
    ...
    def get_random_position(self):
        ...
        x = self.width - 1
        y = self.height - 1
        pos = Position(random.randint(0, x), random.randint(0, y))
