...
urlpatterns = [
    ...
    path('<str:slug>', blog_post_detail_view), #stavljanje url za svaku stranicu koja se kreira. Prethodno se importuje iz views, dinamicko dodeljivanje broja stranice
